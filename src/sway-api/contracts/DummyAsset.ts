...
export type DummyAssetConfigurables = Partial<{
...
export class DummyAssetInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class DummyAsset extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: DummyAssetInterface;
  declare functions: {
