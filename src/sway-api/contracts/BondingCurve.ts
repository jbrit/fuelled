...
export enum BondingCurveErrorInput { WrongAsset = 'WrongAsset', TotalSupplyExceeded = 'TotalSupplyExceeded', SlippageLimitExceeded = 'SlippageLimitExceeded', InsufficientFunds = 'InsufficientFunds', InvalidFundsAmount = 'InvalidFundsAmount', InitializedPool = 'InitializedPool', UninitializedPool = 'UninitializedPool' };
export enum BondingCurveErrorOutput { WrongAsset = 'WrongAsset', TotalSupplyExceeded = 'TotalSupplyExceeded', SlippageLimitExceeded = 'SlippageLimitExceeded', InsufficientFunds = 'InsufficientFunds', InvalidFundsAmount = 'InvalidFundsAmount', InitializedPool = 'InitializedPool', UninitializedPool = 'UninitializedPool' };
...
export type BondingCurveConfigurables = Partial<{
...
const abi = {
  ...
  "concreteTypes": [
    ...
    {
      "type": "enum errors::BondingCurveError",
      "concreteTypeId": "5439e323dd5710c154c92a3aa57eb9f63b43a7c85f95619d29d5e61f9e5f9a71",
      "metadataTypeId": 1
    },
    {
...
export class BondingCurveInterface extends Interface {
  constructor() {
    super(abi);
  }
  ...
  declare functions: {
    ...
    eth_in_by_token_out: FunctionFragment;
    eth_out_by_token_in: FunctionFragment;
    initialize: FunctionFragment;
    sell_token: FunctionFragment;
  };
}

export class BondingCurve extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: BondingCurveInterface;
  declare functions: {
    ...
    buy_token: InvokeFunction<[recepient: IdentityInput, amount: BigNumberish, max_eth_in: BigNumberish], BN>;
    eth_in_by_token_out: InvokeFunction<[token_out: BigNumberish], BN>;
    eth_out_by_token_in: InvokeFunction<[token_in: BigNumberish], BN>;
    initialize: InvokeFunction<[name: StdString, symbol: StdString, description: StdString, image: StdString, twitter: StdString, telegram: StdString, website: StdString], boolean>;
    sell_token: InvokeFunction<[recepient: IdentityInput, amount: BigNumberish, min_eth_out: BigNumberish], BN>;
  };
