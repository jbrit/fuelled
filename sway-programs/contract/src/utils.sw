...
const ETH_LIQUIDITY: u256 = 1_00_000_000;  // 0.1 ETH
const BONDING_CURVE_CUBE_PER_LIQUDITY = 343_00_000_000_00_000_000;
...
pub fn eth_in_by_token_out(total_supply: u64, token_out: u64) -> u64 {
    ...
    let eth_in =  <u64 as TryFrom<u256>>::try_from((new_total_supply.as_u256().pow(3) - total_supply.as_u256().pow(3)) / BONDING_CURVE_CUBE_PER_LIQUDITY.as_u256()).unwrap();
    eth_in
}
